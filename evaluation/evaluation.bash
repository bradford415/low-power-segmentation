...
path="/home/bselee/programming/low-power-segmentation/evaluation"
...
time_output=$(timeout $TIMEOUT python $solution -i ${testImagesDirectory} -o $eval ; 2>&1 > /dev/null )
exit_code=$?
...
if [ $exit_code -eq 124 ]; then
    ...
    mdice=$(python $scoreResults -i $eval -g ${testGroundTruthImagesDirectory} 2>/dev/null)
    accuracy_exit_code=$?
