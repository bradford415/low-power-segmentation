"""Utils for ADMM Pruning taken from here: https://github.com/bzantium/pytorch-admm-pruning/blob/master/utils.py"""
import torch
...
def regularized_nll_loss(args, model, output, target):
    """NLL Loss with L2 regularization - CE Loss without log softmax (instead called at the end 
    they call log softmax of their model)"""
    index = 0
